 ...
 */
			"item:object:events" => "Evénement",
	        "blockmenu:events" => "Evénements",
		    "groups:enableevents"=>"Autoriser les événements du groupe",
			"events:toolbar" => "Evénements",			
			"events:add" => "Ajouter un événement",
			"events:owner" => "Vos événements",
		    "events:group"=>"Evénements du groupe",
			
		    "events:title:user_event" => 'Les événements de la %s',
